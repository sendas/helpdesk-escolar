<template>
  <div class="hd-page about-page">
    <h1 style="font-size:22px;margin-bottom:6px">Sobre esta aplicação</h1>
    <p class="hd-hint" style="margin-bottom:32px">Helpdesk Escolar — Centro de Apoio Digital do Agrupamento</p>

    <!-- Autoria -->
    <div class="hd-card about-card" style="padding:32px;max-width:720px;margin-bottom:24px">
      <div class="about-author-row">
        <div class="about-avatar">PS</div>
        <div>
          <div style="font-size:18px;font-weight:700;margin-bottom:2px">Pedro Sendas de Moura Pereira</div>
          <div style="font-size:13px;color:var(--c-muted)">Docente · Grupo 550 — Informática</div>
        </div>
      </div>
    ...
    <div class="hd-card about-card" style="padding:32px;max-width:720px;margin-bottom:24px">
      ...
      <div style="border-top:1px solid var(--c-border);padding-top:20px;margin-top:4px">
        <div style="font-size:13px;font-weight:600;margin-bottom:10px;color:var(--c-text)">Fluxo de trabalho</div>
    ...
    <div class="hd-card about-card" style="padding:28px;max-width:720px;margin-bottom:24px">
      ...
      <div class="about-tech-grid">
        <div v-for="t in techs" :key="t.name" class="about-tech-item">
          <span class="material-icons" :style="{ color: t.color, fontSize: '18px' }">{{ t.icon }}</span>
          <div>
